        ...
        <div class="info_con clearfix">
            ...
            <form action="">
                <table class="user_info_list">
                    <tr><td><span>用户名：</span></td><td><input type="text" required value="${member.member_nick}" ></td></tr>
                    <tr><td><span>联系方式：</span></td><td><input type="text" required value="${member.phone}" ></td></tr>
                    <tr><td><span>联系地址：</span></td><td><input type="text" required value="${member.address }"></td></tr>
                    <tr><td><span>邮箱：</span></td><td><input type="text" required value="${member.email }"></td></tr>
                    <tr style="text-align: center"><td colspan="2"><input type="submit" value="提交修改"/></td></tr>
