...
<div class="main_con clearfix">
    <div class="right_content clearfix">
        <div class="info_con clearfix">
            ...
            <form action="javascript:if(confirm('确认修改?重新登录后生效')){location='/member.do?opr=update&member_id=${member.member_id}'}">
                <table class="user_info_list" style="width: 980px;font-size: small">
                    ...
                    <tr><td style="text-align: right"><span>收货地址：</span></td><td><input style="width: 400px" type="text" required value="${member.address }"></td></tr>
